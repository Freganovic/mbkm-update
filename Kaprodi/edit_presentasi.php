...
if (isset($_GET['id'])) {
    ...
    $jadwal = $data["jadwal"];
    $lokasi = $data["lokasi"];
    $nilai_lapangan = $data["nilai_lapangan"];
}
                                ...
                                <div class="content">
                                    <form id="form_edit_jenispengajuan" method="post" action="system/edit_presentasi">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="nilai" id="nilai" class="form-control" value="<?php echo $nilai ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pembimbing" id="pembimbing" class="form-control"
                                                        oninvalid="this.setCustomValidity('Mohon pilih dosen pembimbing!')"
                                                        oninput="setCustomValidity('')">
                                                        <?php echo $dosen_options; ?>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" name="jadwal" id="jadwal" class="form-control"
                                                        value="<?php echo htmlspecialchars($jadwal, ENT_QUOTES, 'UTF-8'); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>NILAI LAPANGAN</label>
                                                    <input type="number" name="nilai_lapangan" id="nilai_lapangan" class="form-control" value="<?php echo $nilai_lapangan ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div align="right">
