                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <?php
                                $query_proses = "SELECT * FROM pendaftaran"; // Mengambil semua data
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <?php
                                $query_selesai = "SELECT * FROM pendaftaran WHERE status LIKE 'diterima'";
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <?php
                                $query_selesai = "SELECT * FROM pendaftaran WHERE status LIKE 'ditolak'";
                                $result_selesai = mysqli_query($con, $query_selesai);
                                $banyakdata_selesai = $result_selesai->num_rows;
                                ?>
                                <div align="center">
