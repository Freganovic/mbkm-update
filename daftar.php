            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="#" class="simple-text">
                        MBKM UPB <small>PENDAFTARAN</small>
                    </a>
                </div>
                <ul class="nav">
                    <li class="active">
                            ...
                            <form id="form_user" method="post" action="system/proses_daftar">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nama </label>
                                            <input type="text" name="nama_depan" id="nama_depan" class="form-control" placeholder="Nama" required
                                                oninvalid="this.setCustomValidity('Mohon isi form berikut !')"
                                                oninput="setCustomValidity('')">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="kelas" name="kelas" id="kelas" class="form-control" placeholder="kelas" required
                                                oninvalid="this.setCustomValidity('Mohon isi form berikut !')"
                                                oninput="setCustomValidity('')">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="dosen" id="dosen" class="form-control" required
                                                oninvalid="this.setCustomValidity('Mohon pilih dosen!')"
                                                oninput="setCustomValidity('')">
