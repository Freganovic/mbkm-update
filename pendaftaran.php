...
<body>
                                ...
                                <div class="tab-content">
                                    <div id="semua" class="tab-pane active">
                                        ...
                                        if (isset($_GET['judul'])) {
                                            ...
                                            if ($pengajuan == "") {
                                                $query_semua = "SELECT id, program, periode, dosen_wali, nama, nim, ipk, total_sks, keterangan, status 
                                    FROM pendaftaran 
                                    ...
                                    ORDER BY id DESC";
                                            ...
                                            // Jika filter tidak digunakan, ambil semua data
                                            $query_semua = "SELECT id, program, periode,dosen_wali, nama, nim, ipk, total_sks, keterangan, status 
    ...
    ' . htmlspecialchars($data_semua['status'], ENT_QUOTES, 'UTF-8') . '</td>
            <td>
                <button type="button" class="btn btn-info" onclick="showKeterangan(`' . htmlspecialchars($data_semua['keterangan'], ENT_QUOTES, 'UTF-8') . '`)">
                    Lihat Keterangan
                </button>
            </td>
                          </tr>';
