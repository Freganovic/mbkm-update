                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="content">
                                    <form id="form_user" method="post" action="system/upload_lapangan.php" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>Transkrip nilai lapangan</label>
                                                    <input type="file" name="file_nilai_lapangan" id="form_lapangan" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
