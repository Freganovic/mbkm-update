                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jenis_pengajuan" id="jenis_pengajuan" class="form-control" placeholder="Nama Program MBKM" required
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="periode" id="periode" class="form-control" placeholder="Batch Program MBKM" required
                                                        oninvalid="this.setCustomValidity('Mohon isi form berikut!')"
                                                        oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="tgl_mulai" id="tgl_mulai" class="form-control" required
                                                        oninvalid="this.setCustomValidity('Mohon isi tanggal mulai!')"
                                                        oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="tgl_selesai" id="tgl_selesai" class="form-control" required
                                                        oninvalid="this.setCustomValidity('Mohon isi tanggal selesai!')"
                                                        oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                        </div>
