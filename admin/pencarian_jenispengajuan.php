<?php
    ...
    // Pastikan variabel session di-escape untuk mencegah SQL Injection
    ...
    // Cek jika pengguna bukan role "manajemen"
        ...
        <div class="sidebar-wrapper">
            <div class="logo">
                <a href="index" class="simple-text">
                    ...
                    ?>
                    System Pengajuan<br><small>( MANAJEMEN ) - <?php echo htmlspecialchars($username); ?></small>
                </a>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        $pencarian = isset($_GET["cari"]) ? mysqli_real_escape_string($con, $_GET["cari"]) : '';
                        $query = "SELECT * FROM jenis_pengajuan WHERE jenis_pengajuan LIKE '%$pencarian%'";
                        $result = mysqli_query($con, $query);
                        $no = 1;
                        $banyakdata = $result ? $result->num_rows : 0;
                        ?>
...
<script type="text/javascript">
    ...
    function hapus(id) {
        swal({
            ...
            document.location="hapus_jenispengajuan?id=" + id;
        });
    }
</script>
</body>
