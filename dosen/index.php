    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
                            ...
                            <div class="card">
                                <div class="header">
                                    <h4 class="title" align="center">
                                        Mahasiswa Berstatus <br>
                                        <span class="badge proses indextitle upper">MENDAFTAR</span>
                                    </h4>
                                </div>
                                <?php
                                $query_proses = "
                SELECT * FROM pendaftaran AS p
                JOIN user AS u ON p.pembimbing = u.nama_depan
                            ...
                            <div class="card">
                                <div class="header">
                                    <h4 class="title" align="center">
                                        ...
                                        <span class="badge proses indextitle upper">Diterima</span>
                                    </h4>
                                </div>
                                <?php
                                $query_selesai = "
                SELECT * FROM pendaftaran AS p
                JOIN user AS u ON p.pembimbing = u.nama_depan
                WHERE p.status = 'DITERIMA' AND u.email = '$_SESSION[email]'";
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title" align="center">
                                        Pengajuan Berstatus <br>
                                        <span class="badge menunggu indextitle upper">Ditolak</span>
                                    </h4>
                                </div>
                                <?php
                                $query_ditolak = "
                SELECT * FROM pendaftaran AS p
                JOIN user AS u ON p.pembimbing = u.nama_depan
                WHERE p.status = 'DITOLAK' AND u.email = '$_SESSION[email]'";
                                $result_ditolak = mysqli_query($con, $query_ditolak);
                                $banyakdata_ditolak = $result_ditolak->num_rows;
                                ?>
                                <div align="center">
                                    <h1><?php echo $banyakdata_ditolak ?></h1>
                                    <div class="footer">
                                        <hr>
                                        <div class="stats">
                                            <a href="pendaftaran">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form id="form_catatan" method="post" action="system/proses_catatan">
                                ...
                                <div class="content">
                                    <input type="hidden" name="id_catatan" id="id_catatan" value="<?php echo $data_catatan['id_catatan'] ?>">
                                    <div class="form-group">
                                        <textarea rows="5" class="form-control" placeholder="Tidak Ada Catatan!" name="catatan" id="form_catatan" readonly><?php echo $data_catatan['catatan'] ?></textarea>
                                    </div>
                                    <!-- Tombol submit dihapus agar user hanya bisa melihat catatan -->
                                </div>
                            </form>
